...
## API Documentation
This repository contains the implementation of controllers and routes for managing doctors, patients, and reports. The controllers are organized into separate files, and the routes are defined in corresponding router files.
...
- Endpoints:
  ...
  - POST /doctors/sign-in: Sign in a doctor.
...
- Endpoints:
  -GET /reports/:status: Get reports according to the status filter.
